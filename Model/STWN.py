...
from ST_Distribution_model import *
from Attention import *
from ST_Decompose import *
from AGCN import *
...
class EpsilonTheta(nn.Module):
    def __init__(
        ...
        self.zinb_model = NBNorm_ZeroInflated(c_in=1, c_out=1, hidden=zinb_residual_channels).to(device)
    ...
    def forward(self, inputs, ext_inputs, time, cond):
        ...
        n_params, p, pi = self.predict_zinb(cond[:, :, :, :T_h])
